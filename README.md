...
(char*)__gmpz_get_str(0, 16, term)  

rm -rf build && mkdir build && cd build

cmake -GNinja \
  -DSQISIGN_BUILD_TYPE=broadwell \
  -DCMAKE_BUILD_TYPE=Release \
  -DGMP_LIBRARY=SYSTEM \
  -DCMAKE_INTERPROCEDURAL_OPTIMIZATION=ON \
  -DCMAKE_C_FLAGS_RELEASE="-O3 -DNDEBUG -march=native -mtune=native -flto" \
  -DCMAKE_EXE_LINKER_FLAGS_RELEASE="-Wl,-O3" \
  ..
ninja -j"$(nproc)"

apps/benchmark_lvl1 --iterations=100